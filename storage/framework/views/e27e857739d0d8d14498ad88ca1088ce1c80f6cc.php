<ul class="sidebar-menu">
    ...
    <li class="<?php if(strlen(strstr(Route::currentRouteName(), 'backend.product')) > 0): ?> active <?php endif; ?> treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li class="<?php if(strlen(strstr(Route::currentRouteName(), 'backend.product.producer')) > 0): ?> active <?php endif; ?> treeview">
                <a href="#"><i class="fa fa-tags"></i> Nhà Sản Xuất <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class="<?php if(strlen(strstr(Route::currentRouteName(), 'backend.product.producer.add.get')) > 0): ?> active <?php endif; ?>">
                        <a href="<?php echo e(route('backend.product.producer.add.get')); ?>"><i class="fa fa-plus"></i> Thêm</a>
                        
                    </li>
                    <li class="<?php if(strlen(strstr(Route::currentRouteName(), 'backend.product.producer.list.get')) > 0): ?> active <?php endif; ?>"><a href="<?php echo e(route('backend.product.producer.list.get')); ?>"><i class="fa fa-list"></i> Danh Sách</a></li>
                </ul>
            </li>
            <li class="<?php if(strlen(strstr(Route::currentRouteName(), 'backend.product.color')) > 0): ?> active <?php endif; ?> treeview">
                <a href="#"><i class="fa fa-tags"></i> Màu <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class="<?php if(strlen(strstr(Route::currentRouteName(), 'backend.product.color.add.get')) > 0): ?> active <?php endif; ?>">
                        <a href="<?php echo e(route('backend.product.color.add.get')); ?>"><i class="fa fa-plus"></i> Thêm</a>
                        
                    </li>
                    <li class="<?php if(strlen(strstr(Route::currentRouteName(), 'backend.product.color.list.get')) > 0): ?> active <?php endif; ?>"><a href="<?php echo e(route('backend.product.color.list.get')); ?>"><i class="fa fa-list"></i> Danh Sách</a></li>
                </ul>
            </li>
        </ul>
    </li>
