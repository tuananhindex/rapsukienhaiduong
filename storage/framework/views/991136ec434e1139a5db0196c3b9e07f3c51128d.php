                ...
                <div class="box-body table-responsive no-padding" style="min-height:250px;">
                  <div class="form-inline">
                      ...
                      <select class="form-control filter_language">
                        ...
                        <option value="<?php echo e($val->id); ?>" <?php if((isset($_GET['lang_id']) && $_GET['lang_id'] == $val->id) || $val->id == $df_lang->id ): ?> selected <?php endif; ?>><?php echo e(ucfirst($val->name)); ?> <?php if($val->id == $df_lang->id): ?> - Default <?php endif; ?></option>
                        <?php endforeach; ?>
                      </select>
                  </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo route($e['route'].'.edit.get',[$val->id,$val->language]) ?>"><?php echo e(ucfirst($val->name)); ?></a></td>
...
<script type="text/javascript">
  $('select.filter_cat').change(function(){
      ...
      if(lang){
        if(val == 0){
          location.href = '<?php echo e(route(Route::currentRouteName())); ?>?lang_id='+lang;
        }else{
          location.href = '<?php echo e(route(Route::currentRouteName())); ?>?lang_id='+lang+'&cat_id='+val;
        }
      }else{
        if(val == 0){
          location.href = '<?php echo e(route(Route::currentRouteName())); ?>';
        }else{
          location.href = '<?php echo e(route(Route::currentRouteName())); ?>?cat_id='+val;
        }
      }
  ...
  $('select.filter_language').change(function(){
      ...
      if(cat){
        if(val == 0){
          location.href = '<?php echo e(route(Route::currentRouteName())); ?>?cat_id='+cat;
        }else{
          location.href = '<?php echo e(route(Route::currentRouteName())); ?>?cat_id='+cat+'&lang_id='+val;
        }
      }else{
        if(val == 0){
          location.href = '<?php echo e(route(Route::currentRouteName())); ?>';
        }else{
          location.href = '<?php echo e(route(Route::currentRouteName())); ?>?lang_id='+val;
        }
      }
  });
