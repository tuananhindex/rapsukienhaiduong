						...
						<div class="form-group">
							...
							<?php 
						  	...
						  	<select class="form-control filter_language">
		                        <?php foreach($languages2 as $val): ?>
		                        <option value="<?php echo e($val->id); ?>" <?php if($val->id == $lang): ?> selected <?php endif; ?>><?php echo e(ucfirst($val->name)); ?> <?php if($val->id == $df_lang->id): ?> - Default <?php endif; ?></option>
		                        <?php endforeach; ?>
		                     </select>
						</div>
						<div class="form-group">
    ...
    <div class="modal-content">
      <div class="box box-success">
		...
		<div class="box-body">
			...
			<input type="hidden" name="fk_commonid" value="<?php echo e($index->fk_commonid); ?>">
			<div class="form-group">
			  <label>Tên</label>
			...
			<?php if(isset($posts_lang) && count($posts_lang) > 0): ?>
...
<script type="text/javascript">
	$('select.filter_language').change(function(){
	      var val = $(this).val();
	      location.href = '<?php echo e(route(Route::currentRouteName(),'')); ?>/'+'<?php echo e($index->id); ?>/'+val;
  	});
