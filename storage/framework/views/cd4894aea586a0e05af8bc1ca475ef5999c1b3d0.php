			...
			<div class="box box-primary">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="box-body">
						...
						<div class="form-group">
						  <label>Vị Trí</label>
						  <input type="number" class="form-control" name="position" placeholder="Nhập vị trí" value="<?php echo e($index->position); ?>" required="">
						</div>

						<div class="form-group">
						  <label>Nội Dung</label>
						  <textarea class="form-control" name="content" id="content"><?php echo $index->content; ?></textarea>
