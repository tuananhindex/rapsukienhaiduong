<ul class="sidebar-menu">
    ...
    <li class="<?php if(strlen(strstr(Route::currentRouteName(), 'backend.meta_default')) > 0): ?> active <?php endif; ?>"><a href="<?php echo e(route('backend.meta_default.get')); ?>"><i class="fa fa-tags"></i> <span>Meta Mặc Định</span></a></li>
</ul>