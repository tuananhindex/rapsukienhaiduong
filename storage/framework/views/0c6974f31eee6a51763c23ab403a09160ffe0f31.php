                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td><?php echo e(date('h:i d/m/Y',strtotime($val->created_at))); ?></td>
                      <td><?php if(!empty($val->updated_at)): ?><?php echo e(date('h:i d/m/Y',strtotime($val->updated_at))); ?><?php else: ?> Chưa có cập nhật <?php endif; ?></td>
                      <td>
                        <?php if($val->status == 1): ?>
