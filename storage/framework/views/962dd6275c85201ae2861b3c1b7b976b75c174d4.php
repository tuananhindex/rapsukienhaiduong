        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <section class="clearfix">
                                <section class="breadcrumbs clearfix">
                                    ...
                                    &nbsp;&nbsp;/&nbsp;&nbsp;<a href="javascript:void(0)"><span><?php echo e(ucfirst($index->name)); ?> </a> </span>               
                                </section>
                            </section>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <section class="detail">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h1>
                                            <span><?php echo e($index->name); ?>  </span>
                                        </h1>
                                    </div>
                                ...
                                <section id="product-tab">
                                    ...
                                    <ul id="tb_1" class="tab">
                                        ...
                                        <?php echo Block::tags($index->tags); ?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 pull-left">
                    ...
                    <div>
                        <!-- Vertical Menu --> 
                        <?php echo Block::box_category(); ?>

                    </div>
                    <div>
                        <!--$css_item,$box_width,$position,$num_item_row,$sidebar -->
                        <!--begin box <=4.5-->
                        <?php echo Block::box_sidebar($title_posts_sidebar,$same_posts); ?>
