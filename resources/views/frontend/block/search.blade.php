        ...
        <div id="dnn_ctr446_ContentPane">
            ...
            <div id="dnn_ctr446_ModuleContent" class="DNNModuleContent ModMISACMSC">
                <ul class="breadcrumb news-nav">
                    ...
                    <li>
                        <span id="dnn_ctr446_ListNewsByCategory_lblCategoryName">Tìm kiếm</span>
                    </li>
                    <li class="active">
                        <span id="dnn_ctr446_ListNewsByCategory_lblCategoryName">{{ $key }}</span>
                    </li>
                </ul>
                <div class="head-seperator">
                    <h1 class="news-category-title">
                        <span style="color:#000;">Từ khóa : </span><span id="dnn_ctr446_ListNewsByCategory_lblTitle">{{ $key }}</span>
                    </h1>
                </div>
                    ...
                    <div class="row">
                        <div class="newsbycategory">
                            <div class="col-md-9">
                                ...
                                <img src="{{ asset($val->image) }}" id="dnn_ctr446_ListNewsByCategory_radListNewsByCategory_ctrl0_Img1" class="img-subject img-responsive" />
                                </a>
                            </div>
                            <div class="col-md-15">
                                <h2 class="nbc_title">
