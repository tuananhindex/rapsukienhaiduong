...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en" xmlns:og="http://ogp.me/ns#" xmlns:fb="http://www.facebook.com/2008/fbml">
    <head>
        ...
        <link href="{{ asset('assets/frontend/css/captions.htm') }}" rel="stylesheet">
        <link href="{{ asset('assets/frontend/css/settings.htm') }}" rel="stylesheet">
        <link href="{{ asset('assets/frontend/css/magnific-popup.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/frontend/css/custom.css') }}" rel="stylesheet">
        <!-- Load jQuery Library -->
        <script src="{{ asset('assets/frontend/js/jquery-1.11.min.js') }}"></script>
            ...
            <div class="st-pusher">
                <nav class="st-menu st-effect-3" id="cssmenu-st">
                    <div class="list-group panel">
                        <a href="{{ route('home') }}" target="_self" class="list-group-item-stmenu">
                        Trang chủ                </a> 
                        <!--nếu có sub-->
                        {!! Helper::menu_mobi($menus) !!}
                        <!--end nếu có sub-->
                        <a href="{{ route('img.lib') }}" target="_self" class="list-group-item-stmenu">
                        Thư viện ảnh         </a> 
                        <a href="{{ route('contact') }}" target="_self" class="list-group-item-stmenu">
                        Liên hệ                </a> 
                        <!--nếu có sub-->
                        <!--end nếu có sub-->
                    </div>
                            ...
                            <section class="row-section top-logo top-html " style='  '>
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            <!--module width > 3.5-->
                                            <form action="{{ route('search.post') }}" method="post" class="custom_form ">
                                                    ...
                                                    <div class="reservation-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6">
                                                                ...
                                                                <input minlength="3" class="form_1_input_ho" name="key" type="text" placeholder="Bạn muốn tìm gì ?" value="@if(isset($key)){{ $key }}@endif" >
                                                            </div>
                                    ...
                                    <div class="hidden-sm hidden-xs">
                                        <nav id="nav">
                                            <ul class="nav navbar-nav">
                                                <li><a level='1' href="{{ route('home') }}" target="_self"> Trang chủ</a></li>
                                                {!! Helper::menu($menus) !!}
                                                ...
                                                <li><a href="{{ route('img.lib') }}" target="_self" >Thư viện ảnh</a></li>
                                                <li><a level='1' href="{{ route('contact') }}" target="_self"> Liên hệ</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                    <script>
