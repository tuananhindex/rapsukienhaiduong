                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <section id="product-listitem">
                                <h1>
                                    <p style="font-size: 15px">Kết quả tìm kiếm với từ khóa : <span style="color: #f00; display: inline-table;">"{{ $key }}"</span></p>
                                </h1>
                                @if(count($posts) > 0)
                                ...
                                <article class="catalist col3">
                                    <div class="row">
                                        ...
                                        <figure class="col-lg-9 col-md-8 col-sm-8 col-xs-8">
                                            <a href="{{ route('posts',$val->alias) }}" title="">
                                                <h3>{!! preg_replace("/($key)/i","<strong style='color:#f00 !important'>$1</strong>",$val->name) !!}</h3>
                                            </a>
                                            <p>{!! preg_replace("/($key)/i","<strong style='color:#f00 !important'>$1</strong>",$val->description) !!}.</p>
