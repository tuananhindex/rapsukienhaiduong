                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <section class="utilities col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="view pull-right">
                                    <span>Hiển thị</span>
                                    <a href="{{ route('posts.category',[$index->alias,'grid']) }}"><i class="fa fa-th @if($view == 'grid') active @endif"></i></a>
                                    <a href="{{ route('posts.category',[$index->alias,'list']) }}"><i class="fa fa-th-list @if($view == 'list') active @endif"></i></a>
                                </div>
                            </section>
                            <!-- thanh order san pham -->
                            <!--grid-->
